...
The 0G Compute Network SDK is designed to allow developers to integrate AI capabilities with minimal dependencies. You can:

- Use the SDK without requiring integration with other 0G components
- Access AI inference capabilities directly from any application
- Integrate with existing applications regardless of their blockchain foundations
- Build AI-powered applications with a simplified billing and verification system
