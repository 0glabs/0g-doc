...
0G DA is a fully independent component of the 0G ecosystem. When building rollups with 0G DA, you can:

- Use 0G DA as a standalone data availability layer without other 0G components
- Build your rollup on any execution framework while using 0G DA for data availability
- Leverage 0G DA's security and cost-effectiveness independently
- Combine with other 0G components as needed, but with no dependency requirements
...
* Follow the instructions to set up a [0G DA client node](/docs/developer-hub/building-on-0g/da-integration)
* Set up a [0G DA encoder node](/docs/developer-hub/building-on-0g/da-integration)
