...
title: Storage SDK
sidebar_position: 1
description: Documentation for the 0G Storage SDKs (Go and TypeScript)
keywords: [storage, SDK, API, decentralized storage, integration]
---
...
The 0G Storage SDK can be used independently of other 0G components. You can integrate decentralized storage into any application without needing to use 0G Chain, Compute, or other components. This allows you to:

- Add decentralized storage to existing applications
- Use 0G Storage with any blockchain or no blockchain at all
- Integrate with your current tech stack with minimal changes
