...
<Tabs>
  <TabItem value="docker" label="Run with Docker" default>
    ...
    **Run the Docker container:**
    ...
    ```bash
    docker run -p 3100:3100 0g-da-op-plasma:latest da-server --addr 0.0.0.0 --port 3100 --zg.server <rpc to an da client> //default: 127.0.0.1:51001
    ```
 </TabItem>
  ...
  <TabItem value="source" label="Build from Source">
    ...
    **Run DA Server**
    ```bash
        ./bin/da-server --addr 127.0.0.1 --port 3100 --zg.server <rpc to an da client> //default: 127.0.0.1:51001
    ```
